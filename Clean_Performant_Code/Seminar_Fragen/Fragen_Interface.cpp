...
namespace AbstractClassVsInterface {
    ...
    class AnImplementationOfThisInterface : public Interface
    {
    public:
        AnImplementationOfThisInterface(double value) : m_value{ value } {}
    ...
    void test()
    {
        AnImplementationOfThisInterface obj(123.0);
    }

    // ========================================================
    // Was bringt mir ein Interface // Lose Kopplung // Entkopplung

    Interface* joelServer()
    {
        // AnImplementationOfThisInterface obj(123.0);

        AnImplementationOfThisInterface* obj = new AnImplementationOfThisInterface(123.0);
        
        return obj;
    }

    AnImplementationOfThisInterface* joelServerOlfFashioned()
    {
        // AnImplementationOfThisInterface obj(123.0);
    ...
    void client()
    {
        // Interface Pointer // Schnittstellenzeiger
        Interface* client;
    ...
    void oldFashionedClient()
    {
        AnImplementationOfThisInterface* client;

        client = joelServerOlfFashioned();
