...
namespace ObserverDesignPatternSmartPointer {
    ...
    public:
        ...
        // Aktienkurse
        virtual void update(const std::string&) = 0; // "Diehl/ Siemens WKN 7602423432"
        // virtual void update2(int data) = 0;
    };
    ...
    private:
        std::vector<std::weak_ptr<IObserver>> m_observers2;
        std::list<std::weak_ptr<IObserver>> m_observers;
        std::string                         m_message;  // Status, der sich ändern kann
    ...
    public:
        ...
        void someBusinessLogic() {
            m_message = "changing this message";  // Zustand hat sich geändert
            notify();
    ...
    static void clientCode_01() {
        ...
        // Ein Beispiel der Parameterübergabe:
        // std::weak_ptr<IObserver> observer_parameter;
        // observer_parameter = observer1;
